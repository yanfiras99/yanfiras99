...
**Full-Stack Developer & AI Systems Integrator** — based in Sfax, Tunisia 🇹🇳
...
🚀 **What I'm working on:**
A multimodal **LLM agent** (Telegram bot, tool calling + vision + speech) for real-estate billing management, and **تاج الوقار** — a Flutter Quran-memorization app deployed for an academy of ~200 students.

🤝 **I'm open to collaborating on:**
Web, mobile, and data projects that mix real-world impact with smart AI integration.

🔎 **I'm currently exploring:**
LLM agent architectures (tool calling, multi-model orchestration), reinforcement learning & self-play, and advanced document understanding — sharpening my path toward AI specialization.

💬 **Ask me about:**
Full-stack development (Spring Boot, Angular, Flutter), LLM agents & prompt engineering, OCR / speech pipelines, data structuring for ML, or turning messy real-world data into working products.

⚡ **Fun fact:**
I love reverse-engineering how things work and shipping solutions that actually make daily life easier — usually under a "zero budget, real client" constraint.

---

## 🌐 Connect with Me

[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/yangui-firas-961318343/)
[![GitHub](https://img.shields.io/badge/GitHub-%23121011.svg?logo=github&logoColor=white)](https://github.com/yanfiras99)
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:yanguifiras99@gmail.com)
